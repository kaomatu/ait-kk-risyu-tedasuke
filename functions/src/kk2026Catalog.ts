...
function general(
  ...
  requirementType: RequirementType,
  tags: string[] = [],
  options: Pick<CourseDefinition, "countsTowardCreditCap" | "countForProgression" | "countForGraduation" | "aliases"> = {},
): CourseDefinition {
  return {
    id: `ait.general.${code}`,
    code,
...
const curriculumCourses: CourseDefinition[] = [
  ...
  specialized("K1023", "キャリア意識形成", 2, "required", 2, "fall"),
  specialized("K2113", "キャリアデザインⅡ", 2, "required", 3, "fall"),
  ...
  specialized("K2087", "物理学（電磁気学）", 2, "elective", 2, "spring"),
  ...
  specialized("K2022", "プログラミング及び演習Ⅱ", 3, "required", 1, "fall", { hardPrerequisites: ["ait.kk.K1003"] }),
  specialized("K2088", "アルゴリズムとデータ構造", 2, "elective", 3, "spring"),
  specialized("K2089", "アルゴリズムとデータ構造演習", 1, "elective", 3, "spring", { hardPrerequisites: ["ait.kk.K2088"] }),
  ...
  specialized("K3002", "Ｗｅｂプログラミング及び演習", 3, "required_elective", 3, "fall", { requiredElectiveGroup: "kk-2026-star2", aliases: ["Webプログラミング及び演習"] }),
  ...
  specialized("K2065", "オブジェクト指向プログラミング及び演習Ⅰ", 3, "elective", 2, "spring", { hardPrerequisites: ["ait.kk.K2022"] }),
  ...
  specialized("K3004", "マイコン制御及び演習", 3, "required_elective", 3, "spring", { requiredElectiveGroup: "kk-2026-star2", hardPrerequisites: ["ait.kk.K2035"] }),
  ...
  general("G1830", "コミュニカティブイングリッシュＢ", 1, "required_elective", ["english"]),
  general("G1831", "コミュニカティブイングリッシュＣ", 1, "required", ["english"]),
  general("G3834", "コミュニカティブイングリッシュＤ", 1, "required", ["english"]),
  general("G3832", "ＴＯＥＩＣ・視聴覚英語Ａ", 1, "required_elective", ["english"]),
  general("G3833", "ＴＯＥＩＣ・視聴覚英語Ｂ", 1, "required_elective", ["english"]),
  ...
  general("G3846", "英語圏のことばと文化Ｂ", 2, "required_elective", ["english"]),
  general("G3843", "中国語Ａ", 1, "required_elective", ["language"], { aliases: ["中国語A"] }),
  general("G3844", "中国語Ｂ", 1, "required_elective", ["language"], { aliases: ["中国語B"] }),
  general("G3841", "フランス語Ａ", 1, "required_elective", ["language"], { aliases: ["フランス語A"] }),
  general("G3842", "フランス語Ｂ", 1, "required_elective", ["language"], { aliases: ["フランス語B"] }),
  general("G3839", "ドイツ語Ａ", 1, "required_elective", ["language"], { aliases: ["ドイツ語A"] }),
  general("G3840", "ドイツ語Ｂ", 1, "required_elective", ["language"], { aliases: ["ドイツ語B"] }),
  ...
  general("G2009", "健康・スポーツ科学実習Ⅱ", 1, "elective", [], { aliases: ["健康・スポーツ科学実習II"] }),
  general("G2838", "中国のことばと文化", 2, "elective", ["language"]),
  general("G2839", "フランスのことばと文化", 2, "elective", ["language"]),
  general("G2840", "ドイツのことばと文化", 2, "elective", ["language"]),
