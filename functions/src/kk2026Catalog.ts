...
const curriculumCourses: CourseDefinition[] = [
  ...
  specialized("K1013", "物理実験", 2, "elective", 2, "fall", { hardPrerequisites: ["ait.kk.K1019"] }),
  ...
  specialized("K3005", "データベース及び演習", 3, "elective", 3, "spring", { hardPrerequisites: ["ait.kk.K2083"] }),
  ...
  specialized("K2044", "数値計算", 2, "elective", 2, "fall", { hardPrerequisites: ["ait.kk.K2061", "ait.kk.K2059"] }),
  specialized("K2017", "オペレーションズ・リサーチⅠ", 2, "elective", 3, "spring", { hardPrerequisites: ["ait.kk.K2061"] }),
  specialized("K2018", "オペレーションズ・リサーチⅡ", 2, "elective", 3, "fall", { hardPrerequisites: ["ait.kk.K2017"] }),
  specialized("K2082", "数理論理学", 2, "elective", 2, "spring", { hardPrerequisites: ["ait.kk.K2061"] }),
  ...
  specialized("K2118", "システム制御", 2, "elective", 2, "fall", { hardPrerequisites: ["ait.kk.K2061", "ait.kk.K2059", "ait.kk.K2087"] }),
  ...
  // 教育課程表117頁の「ここから8単位以上」で囲まれた18科目だけを graduation_language とする。
  // 既存の language タグは広い分野分類のため、「〜のことばと文化」等を卒業要件へ誤算入しないよう分離する。
  general("G1829", "コミュニカティブイングリッシュＡ", 1, "required", ["english", "graduation_language"]),
  general("G1830", "コミュニカティブイングリッシュＢ", 1, "required_elective", ["english", "graduation_language"], { hardPrerequisites: ["ait.general.G1829"] }),
  general("G1831", "コミュニカティブイングリッシュＣ", 1, "required", ["english", "graduation_language"]),
  general("G3834", "コミュニカティブイングリッシュＤ", 1, "required", ["english", "graduation_language"], { hardPrerequisites: ["ait.general.G1831"] }),
  general("G3832", "ＴＯＥＩＣ・視聴覚英語Ａ", 1, "required_elective", ["english", "graduation_language"]),
  general("G3833", "ＴＯＥＩＣ・視聴覚英語Ｂ", 1, "required_elective", ["english", "graduation_language"], { hardPrerequisites: ["ait.general.G3832"] }),
  general("G3835", "英語ワークショップＡ：スピーキング＆プレゼンテーション", 1, "required_elective", ["english", "graduation_language"], { aliases: ["英語ワークショップA：スピーキング＆プレゼンテーション"] }),
  general("G3836", "英語ワークショップＢ：上級リーディング", 1, "required_elective", ["english", "graduation_language"], { aliases: ["英語ワークショップB：上級リーディング"] }),
  general("G3837", "英語ワークショップＣ：ビジネスコミュニケーション＆TOEIC演習", 1, "required_elective", ["english", "graduation_language"], { aliases: ["英語ワークショップC：ビジネスコミュニケーション＆TOEIC演習"] }),
  general("G3838", "英語ワークショップＤ：海外留学英語", 1, "required_elective", ["english", "graduation_language"], { aliases: ["英語ワークショップD：海外留学英語"] }),
  general("G3845", "英語圏のことばと文化Ａ", 2, "required_elective", ["english", "graduation_language"]),
  general("G3846", "英語圏のことばと文化Ｂ", 2, "required_elective", ["english", "graduation_language"], { hardPrerequisites: ["ait.general.G3845"] }),
  general("G3843", "中国語Ａ", 1, "required_elective", ["language", "graduation_language"], { aliases: ["中国語A"] }),
  general("G3844", "中国語Ｂ", 1, "required_elective", ["language", "graduation_language"], { aliases: ["中国語B"], hardPrerequisites: ["ait.general.G3843"] }),
  general("G3841", "フランス語Ａ", 1, "required_elective", ["language", "graduation_language"], { aliases: ["フランス語A"] }),
  general("G3842", "フランス語Ｂ", 1, "required_elective", ["language", "graduation_language"], { aliases: ["フランス語B"], hardPrerequisites: ["ait.general.G3841"] }),
  general("G3839", "ドイツ語Ａ", 1, "required_elective", ["language", "graduation_language"], { aliases: ["ドイツ語A"] }),
  general("G3840", "ドイツ語Ｂ", 1, "required_elective", ["language", "graduation_language"], { aliases: ["ドイツ語B"], hardPrerequisites: ["ait.general.G3839"] }),
...
export const kk2026DottedTreeRelationships = [
  ...
  { sourceCourseId: "ait.kk.K1020", targetCourseId: "ait.kk.K2063", sourcePage: 114 },
  { sourceCourseId: "ait.kk.K2059", targetCourseId: "ait.kk.K2017", sourcePage: 115 },
  { sourceCourseId: "ait.kk.K2059", targetCourseId: "ait.kk.K2044", sourcePage: 115 },
  ...
  { sourceCourseId: "ait.kk.K2118", targetCourseId: "ait.kk.K1015", sourcePage: 115 },
